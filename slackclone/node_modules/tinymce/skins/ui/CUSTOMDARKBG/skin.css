...
.tox .tox-comment__gradient::after {
  background: linear-gradient(rgba(46, 46, 46, 0), rgba(46, 46, 46, 0.8));
  bottom: 0;
  content: "";
  display: block;
  height: 5em;
...
.tox .tox-comment__overlaytext p {
  background-color: rgba(46, 46, 46, 0.8);
  box-shadow: 0 0 8px 8px rgba(46, 46, 46, 0.8);
  color: #ffffff;
  text-align: center;
}
...
.tox .tox-dialog {
  ...
  border-style: solid;
  border-width: 1px;
  box-shadow: 0 16px 16px -10px rgba(255, 255, 255, 0.15), 0 0 40px 1px rgba(255, 255, 255, 0.15);
  display: flex;
  flex-direction: column;
  max-height: 100%;
  max-width: 480px;
...
.tox .tox-menubar {
  background: url("data:image/svg+xml;charset=utf8,%3Csvg height='39px' viewBox='0 0 40 39px' width='40' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='0' y='38px' width='100' height='1' fill='%23ccc'/%3E%3C/svg%3E") left 0 top 0 rgba(33, 33, 33, 0.6);
